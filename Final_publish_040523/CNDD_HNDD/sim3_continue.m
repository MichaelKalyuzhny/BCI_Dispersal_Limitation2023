%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Forest simulator version 3 - unparallelized version - CONTINUE BROKEN SIMULATION
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
% Assume time begins at zero, initialize with last sample
function [com_samp, time_samp, runtime] = sim3_continue(inp,next_samp)
...
% Load last sample as initial community:
