%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Forest simulator - Dispersal Limitation null with TWO STAGED DISPERSAL
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%
% THIS VERSION ADDS A SECOND DISPERSAL STAGE

function [com_samp, time_samp] = sim2_NC(inp)
...
% inp.R = 3; %radius of second dispersal 
% 
...
while next_samp_ind < stop_samp_ind
    ...
    if rand > inp.imm_prob % No immigration: generate and disperse seed:
        ...
        seed(1:2) = seed(1:2) + normrnd(0,inp.R,1,2); % ADD SECOND DISPERSAL COMPONENT!
