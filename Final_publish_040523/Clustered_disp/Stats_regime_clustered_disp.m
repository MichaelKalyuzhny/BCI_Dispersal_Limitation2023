%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Compute multiple statistics for the samples of a clustered dispersal
% model
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
function [mean_log_dist, log_mean_dist, CE, log_N20, N20, RND20, log_ND, ND, PCF, samps_per_bin, abd_bin_centers, dist_bin_centers] = Stats_regime_clustered_disp(filename_input,prealloc_size, abd_bin_edges, dist_bin_edges,  min_abd, L, filename_output)
...
% L = 600;
% prealloc_size = 0.2;
% filename_output = 'Stats_regime1_test.mat';
% filename_input = filename_load;
...
to_analyze = find(pop_size_samps >= min_abd);
ly = length(to_analyze);
ly100 = round(ly/100);
...
for ii = 1:ly
    ...
    sp_inds = to_analyze(ii); %find the indexes of this species in this year
    this_abd = pop_size_samps(sp_inds);
    points = pop_samps{sp_inds};
...
if ~isnan(filename_output) %save if required to do so
    save(filename_output, 'mean_log_dist', 'PCF', 'log_mean_dist', 'CE', 'N20', 'RND20', 'log_N20', 'ND', 'log_ND', 'samps_per_bin', 'abd_bin_centers', 'dist_bin_centers')
end
