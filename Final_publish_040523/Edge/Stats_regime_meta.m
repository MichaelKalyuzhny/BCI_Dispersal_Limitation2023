...
function [mean_log_dist, log_mean_dist, CE, log_N20, N20, RND20, log_ND, ND, PCF, abd_bin_centers, dist_bin_centers] = Stats_regime_meta(com_samp, abd_bin_edges, dist_bin_edges, min_abd, max_abd, Tot_L, Lx, Ly, filename)
