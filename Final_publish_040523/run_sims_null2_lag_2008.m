%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Run simulation of null model 2 (with stack) for every species
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
disp('Running Null2 (lag) with H2008 distances: ')
tic
parfor spp = 1:length(species_run)
    ...
    inp.stack_size = inp.J; %number of time steps a tree "waits" in the "stack".
    ...
    inp.print_freq = 1000;
    inp.output_file = ['null2_2008_' sp_dat{sp,'SpeciesCode'}{1}];
