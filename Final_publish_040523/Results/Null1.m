...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
function [com_samp, time_samp, runtime] = Null1(inp)
...
com = zeros(inp.J,3,'single'); %this is the community composition, main dynamic variable. first two columns are coordinates. 3rd is species ID
