%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Null model 3 - a percent of seeds is dispersed at random
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%
function [com_samp, time_samp, runtime] = Null3_LDD(inp)
...
while next_samp_ind < stop_samp_ind
    ...
    if rand>inp.imm_prob % No immigration: generate and disperse seed:
        if rand < inp.prop_random % completely random dispersal
            seed = [rand(1,2,'single')*inp.L com(randi(inp.J,'single'),3)];
        else
